...
Screenshot of a list with square bullets

Figure 1: Unordered list with square bullets.

Some common list types:

Screenshot of some common list types.
...
Screenshot of a list with the bullets replaced with images
...
Screenshot of top-positioned bullet images.
...
Screenshot of default list styles with a larger left indent than paragraphs.
...
Screenshot of bullets sitting outside the text.
...
Screenshot of bullets left-aligned closely with paragraphs.
...
Screenshot of ten-item list, with the markers indented to allow for the 10.
...
Screenshot of leading zeros allowing numbers to left-align consistently.
...
Screenshot of lists set to have text consistently left-aligned.
...
Set a different style for ul and ol
...
Screenshot of unordered list with text wrapping below bullets.
...
Screenshot of a definition list with bold terms and indented definitions.
...
Screenshot of a list in two columns.
...
Screenshot of list with the correct spacing and icon.
